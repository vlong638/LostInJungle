...
namespace LostInJungle.Objects.Entities
{
    public static partial class EntityOperator
    {
        ...
        public static bool DbDelete(this TCreatureSkill entity, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Delete<TCreatureSkill>(session, query);
        }
        ...
        public static bool DbInsert(this TCreatureSkill entity, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Insert<TCreatureSkill>(session, query);
        }
        public static bool DbInsert(this List<TCreatureSkill> entities, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).InsertAll<TCreatureSkill>(session, query);
        }
        public static bool DbUpdate(this TCreatureSkill entity, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Update<TCreatureSkill>(session, query);
        }
        public static bool DbUpdate(this List<TCreatureSkill> entities, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).UpdateAll<TCreatureSkill>(session, query);
        }
        #endregion
        #region 读
        public static TCreatureSkill DbSelect(this TCreatureSkill entity, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Select<TCreatureSkill>(session, query);
        }
        public static List<TCreatureSkill> DbSelect(this List<TCreatureSkill> entities, DbSession session, params string[] fields)
        {
            ...
            query.SelectBuilders.Add(builder);
            return IDbQueryOperator.GetQueryOperator(session).SelectAll<TCreatureSkill>(session, query);
        }
        #endregion
        #endregion
    }
