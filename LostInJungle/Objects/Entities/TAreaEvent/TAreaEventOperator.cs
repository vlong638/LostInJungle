...
namespace LostInJungle.Objects.Entities
{
    public static partial class EntityOperator
    {
        ...
        public static bool DbDelete(this TAreaEvent entity, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Delete<TAreaEvent>(session, query);
        }
        ...
        public static bool DbInsert(this TAreaEvent entity, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Insert<TAreaEvent>(session, query);
        }
        public static bool DbInsert(this List<TAreaEvent> entities, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).InsertAll<TAreaEvent>(session, query);
        }
        public static bool DbUpdate(this TAreaEvent entity, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Update<TAreaEvent>(session, query);
        }
        public static bool DbUpdate(this List<TAreaEvent> entities, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).UpdateAll<TAreaEvent>(session, query);
        }
        #endregion
        #region 读
        public static TAreaEvent DbSelect(this TAreaEvent entity, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Select<TAreaEvent>(session, query);
        }
        public static List<TAreaEvent> DbSelect(this List<TAreaEvent> entities, DbSession session, params string[] fields)
        {
            ...
            query.SelectBuilders.Add(builder);
            return IDbQueryOperator.GetQueryOperator(session).SelectAll<TAreaEvent>(session, query);
        }
        #endregion
        #endregion
    }
