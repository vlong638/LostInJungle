...
namespace LostInJungle.Objects.Entities
{
    public static partial class EntityOperator
    {
        ...
        public static bool DbDelete(this TCreature entity, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Delete<TCreature>(session, query);
        }
        ...
        public static bool DbInsert(this TCreature entity, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Insert<TCreature>(session, query);
        }
        public static bool DbInsert(this List<TCreature> entities, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).InsertAll<TCreature>(session, query);
        }
        public static bool DbUpdate(this TCreature entity, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Update<TCreature>(session, query);
        }
        public static bool DbUpdate(this List<TCreature> entities, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).UpdateAll<TCreature>(session, query);
        }
        #endregion
        #region 读
        public static TCreature DbSelect(this TCreature entity, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Select<TCreature>(session, query);
        }
        public static List<TCreature> DbSelect(this List<TCreature> entities, DbSession session, params string[] fields)
        {
            ...
            query.SelectBuilders.Add(builder);
            return IDbQueryOperator.GetQueryOperator(session).SelectAll<TCreature>(session, query);
        }
        #endregion
        #endregion
    }
