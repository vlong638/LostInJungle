...
namespace LostInJungle.Objects.Entities
{
    public static partial class EntityOperator
    {
        ...
        public static bool DbDelete(this TCreatureQuality entity, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Delete<TCreatureQuality>(session, query);
        }
        ...
        public static bool DbInsert(this TCreatureQuality entity, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Insert<TCreatureQuality>(session, query);
        }
        public static bool DbInsert(this List<TCreatureQuality> entities, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).InsertAll<TCreatureQuality>(session, query);
        }
        public static bool DbUpdate(this TCreatureQuality entity, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Update<TCreatureQuality>(session, query);
        }
        public static bool DbUpdate(this List<TCreatureQuality> entities, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).UpdateAll<TCreatureQuality>(session, query);
        }
        #endregion
        #region 读
        public static TCreatureQuality DbSelect(this TCreatureQuality entity, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Select<TCreatureQuality>(session, query);
        }
        public static List<TCreatureQuality> DbSelect(this List<TCreatureQuality> entities, DbSession session, params string[] fields)
        {
            ...
            query.SelectBuilders.Add(builder);
            return IDbQueryOperator.GetQueryOperator(session).SelectAll<TCreatureQuality>(session, query);
        }
        #endregion
        #endregion
    }
