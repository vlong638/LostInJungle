...
namespace LostInJungle.Objects.Entities
{
    public static partial class EntityOperator
    {
        ...
        public static bool DbDelete(this TArea entity, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Delete<TArea>(session, query);
        }
        ...
        public static bool DbInsert(this TArea entity, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Insert<TArea>(session, query);
        }
        public static bool DbInsert(this List<TArea> entities, DbSession session)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).InsertAll<TArea>(session, query);
        }
        public static bool DbUpdate(this TArea entity, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Update<TArea>(session, query);
        }
        public static bool DbUpdate(this List<TArea> entities, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).UpdateAll<TArea>(session, query);
        }
        #endregion
        #region 读
        public static TArea DbSelect(this TArea entity, DbSession session, params string[] fields)
        {
            ...
            return IDbQueryOperator.GetQueryOperator(session).Select<TArea>(session, query);
        }
        public static List<TArea> DbSelect(this List<TArea> entities, DbSession session, params string[] fields)
        {
            ...
            query.SelectBuilders.Add(builder);
            return IDbQueryOperator.GetQueryOperator(session).SelectAll<TArea>(session, query);
        }
        #endregion
        #endregion
    }
